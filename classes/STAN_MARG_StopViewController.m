...
@interface STAN_MARG_StopViewController ()
...
- (void) removeStopFromFavorites
{
    ...
    [STAN_MARG_MStop setFavoriteStops:newFavoriteStops];
...
- (NSArray *) getNextBuses
{
    ...
    while([departureTimesRS next]) {
        ...
        bus.routeTextColor = [STAN_MARG_MUtil colorFromHexString:[departureTimesRS objectForColumnName:@"route_text_color"]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.section) {
        ...
        case VIEW_ON_MAP_SECTION_INDEX: {
            ...
            STAN_MARG_LiveMapViewController *liveMap = [navController.viewControllers objectAtIndex:0];
